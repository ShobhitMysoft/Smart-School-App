...
public class TakeUrl extends Activity {
    ...
    private static final String TAG = "TakeUrl";
             ...
             public void onResponse(String result) {
                 ...
                 if (result != null) {
                     ...
                     try {
                         ...
                         Log.e(TAG, "onResponse: My Object:-\n " + object);
             ...
             public void onErrorResponse(VolleyError error) {
                 ...
                 try {
                     ...
                     if(error instanceof ClientError) {
                         ...
                         Log.e(TAG, "onErrorResponse: Client Error:- ", error);
                     } else {
                         Toast.makeText(getApplicationContext(), R.string.apiErrorMsg, Toast.LENGTH_SHORT).show();
                     ...
                     Toast.makeText(getApplicationContext(), R.string.apiErrorMsg, Toast.LENGTH_SHORT).show();
                     Log.i(TAG, "onErrorResponse: Null Pointer:- Status:", npe);
                 } catch (Exception e) {
