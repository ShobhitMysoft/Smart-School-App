...
import com.qdocs.smartschool.utils.PermissionUtils;

import java.util.Objects;

public class TransportMapsFragment extends Fragment
        implements
    ...
    private OnMapReadyCallback callback = new OnMapReadyCallback() {
         ...
         * In this case, we just add a marker near spellAdvt, Australia.
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(spellAdvt, 10));
            enableMyLocation();
        }
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_transport_maps, container, false);
    }
    ...
    private void showMissingPermissionError() {
        PermissionUtils.PermissionDeniedDialog
                .newInstance(true).show(requireActivity().getSupportFragmentManager(), "dialog");
    }
}